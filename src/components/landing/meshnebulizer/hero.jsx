...
const MeshNebulizerHero = () => {
  return (
    ...
    >
      ...
      >
        <motion.span
          className="absolute left-[12%] top-[20%] h-6 w-6 rounded-full bg-orange-300/40 blur-[1px]"
          animate={{ y: [0, -20, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.span
          className="absolute right-[10%] top-[30%] h-8 w-8 rounded-full bg-orange-400/40 blur-[1px]"
          animate={{ y: [0, -30, 0] }}
      ...
      {/* Side Images */}
      <motion.img
        src="/images/products/meshnebulizer/meshnebulizer2.png"
        alt="Mesh Nebulizer front view"
        aria-hidden
        ...
        animate={{ opacity: 1, x: 0, rotate: [-8, -2, -8], y: [0, -6, 0] }}
        transition={{
      ...
      <motion.img
        ...
        alt="Mesh Nebulizer side view"
        aria-hidden
        className="pointer-events-none hidden md:block absolute right-4 lg:right-8 top-1/2 -translate-y-1/2 w-40 md:w-56 lg:w-64 xl:w-85 drop-shadow-2xl"
        initial={{ opacity: 0, x: 40, rotate: 8 }}
        animate={{ opacity: 1, x: 0, rotate: [8, 2, 8], y: [0, -6, 0] }}
        transition={{
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
        ...
        >
          Quiet. Portable. Efficient. Experience next-level respiratory therapy anytime, anywhere.
        </motion.p>
      </div>
...
export default MeshNebulizerHero;
